 ...
 ** نمایش وضعیت پروکسی و اینترنت با چراغ RGB روتر **
...
| 🟣 **Purple** | 🚫 Google Down | Google blocked, but Iran servers are reachable |
...
| 🟣 **بنفش** | 🚫 گوگل قطعه | گوگل فیلتره، ولی سرورهای ایران در دسترسن |
...
1. **تست پروکسی** - اتصال به گوگل از طریق پروکسی SOCKS5
...
این پروژه تحت لایسنس MIT منتشر شده - فایل [LICENSE](LICENSE) رو برای جزئیات ببین.
